...
{/* --- 新增：服务流程 (修复了间距，统一了浅色风格，加深了序号水印) --- */}
      <section className="px-6 max-w-2xl mx-auto mb-24 mt-24">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden group hover:shadow-md transition-all">
            {/* 右上角大序号水印 - 已加深 */}
            <div className="absolute right-[-10px] top-[-15px] text-9xl font-bold text-gray-200 opacity-40 select-none group-hover:text-blue-100 transition-colors">
              1
            </div>
            <div className="relative z-10">
              ...
              <p className="text-base text-gray-500 leading-relaxed">
                <span className="block font-semibold text-gray-700 mb-2 text-lg">法律服务的第一步，是理性的回归。</span>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden group hover:shadow-md transition-all">
            ...
            <div className="relative z-10">
              ...
              <p className="text-base text-gray-500 leading-relaxed">
                <span className="block font-semibold text-gray-700 mb-2 text-lg">诉讼并非唯一手段，而是手段之一。</span>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden group hover:shadow-md transition-all">
            ...
            <div className="relative z-10">
              <h3 className="text-xl font-bold text-gray-800 mb-4 flex items-center gap-3">
                <span className="w-3 h-3 rounded-full bg-blue-600 shadow-[0_0_15px_rgba(37,99,235,0.3)]"></span>
                精细化代理与交付
              </h3>
              <p className="text-base text-gray-500 leading-relaxed">
                <span className="block font-semibold text-gray-700 mb-2 text-lg">细节决定案件走向。</span>
