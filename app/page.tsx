...
const casesData = {
  civil: [
    ...
    {
      title: "知识产权与竞争纠纷",
      desc: "商标侵权、著作权保护及不正当竞争诉讼。",
    },
  ],
  criminal: [
    {
      title: "侵犯公民人身/民主权利罪",
      desc: "故意伤害、非法拘禁等重大人身犯罪辩护。",
    },
...
export default function Portfolio() {
  const [activeTab, setActiveTab] = useState<"civil" | "criminal" | "admin">(
    "civil"
  );
      ...
      >
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm md:text-base text-gray-500 font-medium tracking-wide uppercase">
              中华人民共和国执业律师 <span className="mx-2">|</span>{" "}
              民商事、刑事权益捍卫者
            </p>
            <p className="text-xl text-gray-800 font-serif italic pt-2">
              "诚心诚意，尽心尽力"
            </p>
          </div>
            ...
            {/* <SocialButton 
              icon={
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                  <path d="M19.5 3h-2.2c-2.8 0-4.8 1.5-4.8 4.5v1.8H9.8v3.6h2.7v9.4h4.3v-9.4h3l.4-3.6h-3.4V7.8c0-1 .2-1.4 1.4-1.4h1.3V3z"/>
                </svg> 
              } 
              label="抖音" 
        ...
        <motion.section variants={fadeInUp} className="mt-24 space-y-8">
          ...
          <div className="flex space-x-2 bg-gray-100 p-1 rounded-lg w-fit">
            <TabButton
              active={activeTab === "civil"}
              onClick={() => setActiveTab("civil")}
            >
              民事案件
            </TabButton>
            <TabButton
              active={activeTab === "criminal"}
        ...
        <motion.footer
          variants={fadeInUp}
          className="mt-32 pt-12 border-t border-gray-200 text-center space-y-4 pb-12"
        >
          <p className="text-lg font-serif italic text-gray-600">
            "诚心诚意对待每一位当事人的委托，尽心尽力争取哪怕百分之一的可能。"
          </p>
        ...
        <div className="text-center space-y-6 py-4">
          ...
          <div className="flex justify-center space-x-4">
            <button
              ...
              className="flex items-center px-4 py-2 bg-gray-100 rounded-full hover:bg-gray-200 transition"
            >
              <Copy size={16} className="mr-2" /> 复制
            </button>
            <a
              href={`tel:${PHONE_NUMBER}`}
              className="flex items-center px-4 py-2 bg-black text-white rounded-full hover:bg-gray-800 transition"
            >
